                      ...
                      var AssessmentsTab = HomeContainer.Helpers.TabControl();
                      {
                          ...
                          var HomeContainerTab = AssessmentsTab.AddTab("Movies");
                          {
                              var Row = HomeContainerTab.Helpers.DivC("row margin0");
                              {
                                  ...
                                  {
                                      RowColMain.Helpers.HTML().Heading2("Welcome to Movie Section");
                                              ...
                                              var RowContentDiv = ContentDiv.Helpers.DivC("row");
                                              {
                                                  ...
                                                  var MovieColContentDiv = RowContentDiv.Helpers.DivC("col-md-12");
                                                  {
                                                      ...
                                                      var MovieColContainer = MovieColContentDiv.Helpers.DivC("movies-container");
                                                      {
                                                          ...
                                                          var WatchBtn = MoviesWatchedDiv.Helpers.Button("View Details Now", Singular.Web.ButtonMainStyle.NoStyle, Singular.Web.ButtonSize.Normal, Singular.Web.FontAwesomeIcon.None);
                                                          {
                                                              WatchBtn.AddBinding(Singular.Web.KnockoutBindingString.click, "RentMovie($data)");
                          ...
                          var HomeContainerTab1 = AssessmentsTab.AddTab("Products");
                          {
                              var Row = HomeContainerTab1.Helpers.DivC("row margin0");
                              {
                                  var RowColMain = Row.Helpers.DivC("col-md-12");
                                  {
                                      RowColMain.Helpers.HTML().Heading2("Welcome to Snack Express");
                                              ...
                                              var RowContentDiv = ContentDiv.Helpers.DivC("row");
                                              {
                                                  ...
                                                  var MovieColContentDiv = RowContentDiv.Helpers.DivC("col-md-12");
                                                  {
                                                      ...
                                                      var MovieColContainer = MovieColContentDiv.Helpers.DivC("movies-container");
                                                      {
                                                          ...
                                                          {
                                                              //WatchBtn.AddBinding(Singular.Web.KnockoutBindingString.text, c => "Add To Cart");
