// Generated 26 Oct 2021 12:58 - Singular Systems Object Generator Version 2.2.694
//<auto-generated/>
using System;
using Csla;
...
namespace MELib.Products
{
     ...
     : SingularBusinessBase<Product>
    {
        ...
        //Required(ErrorMessage = "ProductCategory required"),
        //Singular.DataAnnotations.DropDownWeb(typeof(MELib.RO.ROProductCategoryList), ValueMember = "CategoryID", DisplayMember = "CategoryName")]

        [Display(Name = "Category Name", Description = " "),
        Singular.DataAnnotations.DropDownWeb(typeof(MELib.Categories.CategoryList), 
            Source = Singular.DataAnnotations.DropDownWeb.SourceType.All, 
            UnselectedText = "Select Category", DisplayMember = "CategoryName", ValueMember = "CategoryID")]
        ...
        /// <summary>
        /// Gets and sets the Stocked Date value
        /// </summary>
        [Display(Name = "Stocked Date", Description = ""),
        Required(ErrorMessage = "Stocked Date required")]
        public DateTime StockedDate
        {
            ...
            set
            {
                SetProperty(StockedDateProperty, value);
            }
        }
