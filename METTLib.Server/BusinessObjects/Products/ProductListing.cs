...
namespace MELib.Product
{
    ...
    public class ProductListing
     : SingularBusinessBase<ProductListing>
    {
        ...
        public override string ToString()
        {
            if (this.ProductName.Length == 0)
            {
                if (this.IsNew)
                {
                    return String.Format("New {0}", "Product Listing");
                }
                else
                {
                    return String.Format("Blank {0}", "Product Listing");
                }
            }
            else
            {
        ...
        protected override void OnCreate()
        {
            ...
            // Set any variables here, not in the constructor or NewProductListing() method.
        }

        public static ProductListing NewProductListing()
        {
            return DataPortal.CreateChild<ProductListing>();
        }
        ...
        internal static ProductListing GetProductListing(SafeDataReader dr)
        {
