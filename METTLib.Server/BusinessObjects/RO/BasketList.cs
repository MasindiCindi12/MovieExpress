// Generated 17 Nov 2021 09:42 - Singular Systems Object Generator Version 2.2.694
//<auto-generated/>
using System;
using Csla;
...
namespace MELib.RO
{
     ...
     : SingularBusinessListBase<BasketList, Basket>
    {
        ...
        public static BasketList GetBasketList(int ItemID, int UserID)
        {
            return DataPortal.Fetch<BasketList>(new Criteria { ItemID = ItemID, UserID= UserID });
        }
            ...
            using (SqlConnection cn = new SqlConnection(Singular.Settings.ConnectionString))
            {
                ...
                try
                {
                    using (SqlCommand cm = cn.CreateCommand())
                    {
                        ...
                        cm.CommandText = "GetProcs.getROBasketList";
                        cm.Parameters.AddWithValue("@ItemID", Singular.Misc.NothingDBNull(crit.ItemID));
