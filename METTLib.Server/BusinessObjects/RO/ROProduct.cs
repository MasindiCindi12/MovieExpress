...
namespace MELib.RO
{
    ...
    public class ROProduct
     : SingularBusinessBase<ROProduct>
    {
        ...
        public static ROProduct NewProduct()
        {
            return DataPortal.CreateChild<ROProduct>();
        }
        ...
        internal static ROProduct GetProduct(SafeDataReader dr)
        {
            var p = new ROProduct();
            p.Fetch(dr);
            return p;
