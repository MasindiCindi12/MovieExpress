     ...
     : SingularBusinessBase<TempUser>
    {
        ...
        public override string ToString()
        {
            if (this.UserName.Length == 0)
            {
                if (this.IsNew)
                {
                    return String.Format("New {0}", "Temp User");
                }
                else
                {
                    return String.Format("Blank {0}", "Temp User");
                }
            }
            else
            {
        ...
        protected override void OnCreate()
        {
            ...
            // Set any variables here, not in the constructor or NewTempUser() method.
        }

        public static TempUser NewTempUser()
        {
            return DataPortal.CreateChild<TempUser>();
        }
        ...
        internal static TempUser GetTempUser(SafeDataReader dr)
        {
            var t = new TempUser();
            t.Fetch(dr);
            return t;
