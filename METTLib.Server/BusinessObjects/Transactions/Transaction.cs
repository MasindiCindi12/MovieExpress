// Generated 11 Nov 2021 14:22 - Singular Systems Object Generator Version 2.2.694
//<auto-generated/>
using System;
using Csla;
...
namespace MELib.Transactions
{
     ...
     : SingularBusinessBase<Transaction>
    {
        ...
        public static PropertyInfo<int?> ShipmentMethodIDProperty = RegisterProperty<int?>(c => c.ShipmentMethodID, "Shipment Method", null);
        /// <summary>
        /// Gets and sets the Shipment Method value
        /// </summary>
        [Display(Name = "Shipment Method", Description = ""),
        //Required(ErrorMessage = "Shipment Method required"),
        Singular.DataAnnotations.DropDownWeb(typeof(MELib.Shipment.ShipmentMethodList), ValueMember = "ShipmentMethodID", DisplayMember = "ShipmentMethodName")]
        public int? ShipmentMethodID
        {
            get { return GetProperty(ShipmentMethodIDProperty); }
            set { SetProperty(ShipmentMethodIDProperty, value); }
        }
        ...
        protected void Fetch(SafeDataReader sdr)
        {
            using (BypassPropertyChecks)
            {
                ...
                LoadProperty(ShipmentMethodIDProperty, Singular.Misc.ZeroNothing(sdr.GetInt32(i++)));
            }
        ...
        protected override Action<SqlCommand> SetupSaveCommand(SqlCommand cm)
        {
            ...
            cm.Parameters.AddWithValue("@ShipmentMethodID", Singular.Misc.NothingDBNull(GetProperty(ShipmentMethodIDProperty)));
